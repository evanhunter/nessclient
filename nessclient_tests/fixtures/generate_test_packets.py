...
def Gemerate_Input_To_Ness_User_Interface_Valid_Packets() -> tuple[str, str]:
    Input_To_Ness_User_Interface_Valid_Packets = []
...
def Gemerate_Data_For_Output_From_Ness_Event_Data_Packets() -> tuple[str, str]:
...
def Gemerate_Output_From_Ness_Event_Data_Valid_Packets() -> tuple[str, str]:
...
def Generate_Output_From_Ness_Status_Update_Valid_Data():
    data: list[tuple[str, str]] = []
...
def Gemerate_Output_From_Ness_Status_Update_Valid_Packets():
...
def select_bitfield(bitfield: enum.Enum):
