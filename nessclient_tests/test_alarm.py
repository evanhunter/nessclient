...
def test_handle_event_zone_update_callback(alarm: Alarm) -> None:
    ...
    alarm.handle_event(event)
    assert cb.call_count == 3  # noqa: PLR2004 # Magic value not worth a constant
...
def test_handle_event_arming_update_callback(alarm: Alarm) -> None:
    ...
    alarm.handle_event(
        SystemStatusEvent(
            address=None,
            timestamp=None,
            event_type=SystemStatusEvent.EventType.ARMED_AWAY,
            area=0,
            zone=1,
        )
    )
...
def test_handle_event_system_status_alarm(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.ALARM,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_alarm_restore_while_disarmed(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.ALARM_RESTORE,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_entry_delay_start(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.ENTRY_DELAY_START,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_entry_delay_end(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.ENTRY_DELAY_END,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_exit_delay_start(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.EXIT_DELAY_START,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_exit_delay_end_from_exit_delay(
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.EXIT_DELAY_END,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_disarmed(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.DISARMED,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
...
def test_handle_event_system_status_arming_delayed(alarm: Alarm) -> None:
    ...
    event = SystemStatusEvent(
        address=None,
        timestamp=None,
        event_type=SystemStatusEvent.EventType.ARMING_DELAYED,
        area=0,
        zone=1,
    )
    alarm.handle_event(event)
